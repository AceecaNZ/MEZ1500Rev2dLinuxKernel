...
static int s3c2410wdt_release(struct inode *inode, struct file *file)
{
	...
	if (expect_close == 42)
		...
		// 2011-04-28 SV: A pain in the butt bug. This error happens when exiting the Qt4 demo. I have no idea why :(
		// So will just stop the dog instead. I'm sure the dog will bite us later on.
		s3c2410wdt_stop();
